      ...
      <div className="text-center">
        ...
        >
          <motion.a
            ...
            href="https://github.com/Balajibalu19"
            target="_blank"
          ...
          <motion.a
            whileHover={{ scale: 1.1 }}
            href="https://www.linkedin.com/in/balaji-doppani"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-400 hover:text-white transition-colors"
          >
          ...
          <motion.a
            whileHover={{ scale: 1.1 }}
            href="mailto:balajidoppani@gmail.com"
            className="text-gray-400 hover:text-white transition-colors"
          >
          ...
          <motion.a
            whileHover={{ scale: 1.1 }}
            className="text-gray-400 hover:text-white transition-colors"
            href="https://drive.google.com/file/d/1CqunABd38IdEd5IzCswM6qOaGoUVKnt5/view?usp=drivesdk"
